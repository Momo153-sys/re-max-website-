...
<div className="btn-group">
  ...
  <input className="form-check-input" type="checkbox" value="" id={`neighborhood-${index}`} />
...
<div className="btn-group">
  <select className="form-select" aria-label="Default select example" style={{width: '100%', height: '100%',marginTop:'5%',textAlign:'center',fontSize: '20px'}}>
  <option defaultValue="homeForSale">Home For Sale</option>
...
<div id="carouselExampleFade1" className="carousel slide carousel-fade">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="/images/house-t4-for-sale-benavente-1.png" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t4-for-sale-benavente-2.png" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t4-for-sale-benavente-3.png" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t4-for-sale-benavente-4.jpg" className="d-block w-100" alt="House Image"/>
    </div>
  </div>
...
<div id="carouselExampleFade2" className="carousel slide carousel-fade">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="/images/house-t4-for-sale-bairro-auto-1.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t4-for-sale-bairro-auto-2.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t4-for-sale-bairro-auto-3.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t4-for-sale-bairro-auto-4.jpg" className="d-block w-100" alt="House Image"/>
    </div>
  </div>
...
<div id="carouselExampleFade3" className="carousel slide carousel-fade">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="/images/house-t4-for-sale-leceia-1.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t4-for-sale-leceia-2.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t4-for-sale-leceia-3.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t4-for-sale-leceia-4.jpg" className="d-block w-100" alt="House Image"/>
    </div>
  </div>
...
<div id="carouselExampleFade4" className="carousel slide carousel-fade">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="/images/apartment-t3-cascais-1.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/apartment-t3-cascais-2.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/apartment-t3-cascais-3.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/apartment-t3-cascais-4.jpg" className="d-block w-100" alt="House Image"/>
    </div>
  </div>
...
<div id="carouselExampleFade5" className="carousel slide carousel-fade">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="/images/apartment-t2-ajuda-1.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/apartment-t2-ajuda-2.png" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/apartment-t2-ajuda-3.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/apartment-t2-ajuda-4.jpg" className="d-block w-100" alt="House Image"/>
    </div>
  </div>
...
<div id="carouselExampleFade6" className="carousel slide carousel-fade">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="/images/house-t7-oeiras-1.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t7-oeiras-2.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t7-oeiras-3.jpg" className="d-block w-100" alt="House Image"/>
    </div>
    <div className="carousel-item">
      <img src="/images/house-t7-oeiras-4.jpg" className="d-block w-100" alt="House Image"/>
    </div>
  </div>
