...
const page = () => {
  ...
  return (
	...
	<nav className="navbar bg-body-tertiary sticky-top">
        ...
        <img src="https://www.remax.nl/wp-content/uploads/2020/07/logo-remax.png" alt="Logo" className="d-inline-block align-text-top" />
    </a>
			</div>
    <div className= {styles.navButtons}>
	<button className= {styles.navButton}> Free Valuation
  		<span></span>
		</button>
	...
	<div className="offcanvas offcanvas-start" tabIndex= {-1} id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div className={`offcanvas-body ${styles.offCanvaBody}`}>
      <div className={styles.LinkGroup}>
  <h4 className={styles.CanvaLinkTitle}>
  Offer
  </h4>
  <div className="list-group">
  <a href='#' className="list-group-item list-group-item-action list-group-item-light">Purchase Offer</a>
  <a href='#' className="list-group-item list-group-item-action list-group-item-light">Rental Offer</a>
  <a href='#' className="list-group-item list-group-item-action list-group-item-light">BOG Offer</a>
  <a  href='#' className="list-group-item list-group-item-action list-group-item-light">Total Offer</a>
</div>
</div>
<div className={styles.LinkGroup}>
  <h4 className={styles.CanvaLinkTitle}>
...
<div className = {styles.footer}>
  ...
  <a href="#" className={`${styles.socialButton} ${styles.github}`}>
    <svg className="cf-icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="-2.5 0 19 19"><path d="M9.464 17.178a4.506 4.506 0 0 1-2.013.317 4.29 4.29 0 0 1-2.007-.317.746.746 0 0 1-.277-.587c0-.22-.008-.798-.012-1.567-2.564.557-3.105-1.236-3.105-1.236a2.44 2.44 0 0 0-1.024-1.348c-.836-.572.063-.56.063-.56a1.937 1.937 0 0 1 1.412.95 1.962 1.962 0 0 0 2.682.765 1.971 1.971 0 0 1 .586-1.233c-2.046-.232-4.198-1.023-4.198-4.554a3.566 3.566 0 0 1 .948-2.474 3.313 3.313 0 0 1 .091-2.438s.773-.248 2.534.945a8.727 8.727 0 0 1 4.615 0c1.76-1.193 2.532-.945 2.532-.945a3.31 3.31 0 0 1 .092 2.438 3.562 3.562 0 0 1 .947 2.474c0 3.54-2.155 4.32-4.208 4.548a2.195 2.195 0 0 1 .625 1.706c0 1.232-.011 2.227-.011 2.529a.694.694 0 0 1-.272.587z"></path></svg>
      ...
      <a href="#" className={`${styles.socialButton} ${styles.linkedin}`}>
...
<g id="XMLID_834_">
  ...
  <a href="#" className={`${styles.socialButton} ${styles.instagram}`}>
...
<div className="btn-group dropup">
  <button type="button" className={`btn btn-secondary dropdown-toggle ${styles.workAreasButton}`} data-bs-toggle="dropdown" aria-expanded="false">
    Work Areas
  </button>
  <ul className="dropdown-menu">
    <li><a className="dropdown-item" href="#">Real Estate Agent Almere</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Amsterdam</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Barendrecht</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Breda</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Hoofddorp</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Hoorn</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Leiden</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Leidsche Rijn</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Leidschendam</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Roosendaal</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Rotterdam</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Tilburg</a></li>
    <li><a className="dropdown-item" href="#">Real Estate Agent Utrecht </a></li>
  </ul>
</div>
  </div>
	</>
