...
const page = () => {
  ...
  <option value="3">Date Old-New</option>
        ...
        <div className={styles.homesGridContainer}>
            ...
            <select className="form-select" aria-label="Default select example" style ={{width: '100%',textAlign: 'center',marginLeft: '0%'}} defaultValue ='priceOf'>
  <option value="priceOf">Choose</option>
  <option value="noPreference">Price Low-High</option>
  <option value="two-fifty"> Price High-Low</option>
  <option value="3">Address</option>
  <option value="1">Place</option>
