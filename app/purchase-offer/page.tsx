...
const page = () => {
  return (
    ...
    <h2 className={styles.offerTitle}>Purchase Offers</h2>
    </section>
    <div className ={styles.filterSection}>
        ...
        <div className = {styles.houseFilterContainer}>
        <select className="form-select" aria-label="Default select example" defaultValue ='priceOf'>
  ...
  <option value="3">&euro; 2500,-</option>
        ...
        <div className = {styles.houseFilterContainer}>
        <select className="form-select" aria-label="Default select example" defaultValue ='priceOf'>
  <option value="priceOf">Price Up To</option>
  <option value="noPreference">No Preference</option>
  <option value="two-fifty"> &euro; 250,-</option>
  <option value="3">&euro; 500,-</option>
  <option value="1">&euro; 750,-</option>
  ...
  <option value="3">&euro; 2500,-</option>
    ...
    <h2> 5 Homes Found</h2>
        ...
        Sort By: <select className="form-select" aria-label="Default select example" defaultValue ='priceOf'>
  <option value="priceOf">Choose an Option</option>
  ...
  <option value="3">Date Old-New</option>
        ...
        <div className={styles.homesGridContainer}>
            ...
            <select className="form-select" aria-label="Default select example" style ={{width: '60%',textAlign: 'center',marginLeft: '25%'}} defaultValue ='priceOf'>
  <option value="priceOf">Choose an Option</option>
  <option value="noPreference">Price Low-High</option>
  <option value="two-fifty"> Price High-Low</option>
  <option value="3">Address</option>
...
<div className="card">
  ...
  <p className="card-text" style={{color: 'red', textDecoration: 'uppercase'}}> Remax direct hoorn</p>
    ...
    <div style={{display: 'flex', justifyContent: 'space-around',margin:'1%', paddingTop:'1%', borderTop:'1px solid rgba(39, 73, 74, 0.2)',}}>
      ...
      <div style={{width: '30%',display: 'flex',justifyContent:'center' }}>
        <div>
        <img src="/images/bathroom.png" style={{width: '20px'}} alt=""  />
        </div>
      <div>
        3
      </div>
